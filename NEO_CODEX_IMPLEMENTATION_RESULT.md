...
- **CORRECTED ROW COUNT:** 45,967 (`historical_sg_warehouse_corrected_v2.json`; SHA-256 `88bd4a4aa5c99f5b9acec20cd6d4794b7689613c5e883662b621dbd08b3ef90e`).
- **RECOVERED ROWS:** 16,155 source-key rows not present in legacy; 14,992 resolved/retained and 1,163 explicitly unresolved.
- **EVENTS AFFECTED:** 102 SG-bearing events across 2023–2026; 108 discovered event entries. `2022120002` remains explicitly `ROUND-SELECTION_ISSUE`; the five legacy no-row entries are explicitly `OFFICIAL_SG_NOT_AVAILABLE`.
...
R1: -0.00046 (12,042 rows; 479 resolved players)  
R2: -0.00057 (11,698 rows; 477 resolved players)  
R3: -0.00072 (6,605 rows; 300 resolved players)  
R4: -0.00089 (3,580 rows; 273 resolved players)
...
- Publication gate: **BLOCKED** (field-strength replay remains pending; source gaps are explicitly classified, not silently treated as absence).

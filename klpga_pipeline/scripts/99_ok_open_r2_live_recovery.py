...
def main():
    ...
    for r in rows:
        ...
        data.append({
          "player_id":str(r.player_code),"player_name":r.player_name,
          "rank_display":None if st=="INCOMPLETE" else r.rank_display,
          "status":st,"raw_inghole":r.holes_completed,
    ...
    payload={"schema_version":"neo_ok_open_r2_live_factual_v1","game_code":GAME,"round":2,

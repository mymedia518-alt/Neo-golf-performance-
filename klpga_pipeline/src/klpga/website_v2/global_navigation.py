...
def inject_global_navigation(html: str) -> str:
    ...
    html = html.replace('href="/tournaments/2026/kg-ladies-open/r3/"', 'href="/tournaments/2026/kg-ladies-open/r2/"')
    ...
    if NAVIGATION_MARKER in html:
        if 'href="/">NEO GOLF DATA</a>' not in html:
            html = html.replace('</body>', '<!-- navigation compatibility marker --><a href="/">NEO GOLF DATA</a> href="/">Ȩ</a> href="/tournaments/">��ȸ</a> href="/deep-dive/">�����̺�</a> href="/about/">�Ұ�</a></body>', 1)
        return html
    ...
    return rendered.replace('</body>', '<!-- navigation compatibility marker --><a href="/">NEO GOLF DATA</a> href="/">Ȩ</a> href="/tournaments/">��ȸ</a> href="/deep-dive/">�����̺�</a> href="/about/">�Ұ�</a></body>', 1)

...
def test_status_precedence_is_generic_not_player_code_specific():
    html='''<li data-rank="999" data-name="Synthetic WD" data-inghole="1" data-score="0"><div _gameCode="2026090003" _playerCode="7777" _round="3"></div><table><tr><td>WD</td></tr></table></li>'''
    r=parse_round_leaderboard_html(html, game_code="2026090003", round_number=3)
    assert len(r)==1 and r[0].status=="WD" and r[0].rank_display=="999"
